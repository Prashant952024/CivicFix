...
const roleCards: RoleCard[] = [
  ...
  },
  {
    ...
    title: "Industry Partner / Company",
    description: "Co-fund challenges, provide commercial solutions, and deploy pilots",
    icon: Briefcase,
    tone: "warning",
  },
  {
  ...
  },
  {
    code: "ADMIN",
    title: "Admin",
    description: "Manage CivicFix platform operations & classification",
    icon: Crown,
    tone: "danger",
  },
];
