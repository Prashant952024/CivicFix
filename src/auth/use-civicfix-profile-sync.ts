...
const PROFILE_SELECT =
  "id, clerk_user_id, full_name, email, phone, role_id, department_id, employee_id, designation, is_active, avatar_url, institution_id, organization_id, joined_at, created_at, updated_at, role:roles(code)";
